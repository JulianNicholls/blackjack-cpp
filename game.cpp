...
Game::Game(const CPPRaylib::Window &window)
    ...
    , stand_button_{
          {.pos = { Constants::ButtonStart.x, Constants::ButtonStart.y + Constants::ButtonSize.y + Constants::ButtonMargin},
           .size = Constants::ButtonSize,
           .bg_colour = BLUE,
           .text_colour = WHITE,
           .font = font_,
           ...
           .shadow = CPPRaylib::SHADOW}}
    , split_button_{
          {.pos = { Constants::ButtonStart.x, Constants::ButtonStart.y + 2.0f * (Constants::ButtonSize.y + Constants::ButtonMargin)},
           .size = Constants::ButtonSize,
           .bg_colour = BROWN,
           .text_colour = WHITE,
           .font = font_,
